...
?>
	...
	<th><a href="addcategories.php" class="btn btn-success">Add New</a></th>
                    </tr></thead>
                    <tbody>
                      <?php 
                        $result=mysqli_query($con,"select cat_id, cat_title from categories")or die ("query 2 incorrect.......");
