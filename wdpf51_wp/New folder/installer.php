...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20220927_shopianbd_ad3b4731a6e1d71c8442_20220927123340_archive.zip';
        const ARCHIVE_SIZE       = '33544802';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'ad3b473-27123340';
        const SECONDARY_PACKAGE_HASH = 'a759426-27123340';
        const VERSION            = '1.5.0';
